      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {jobs.map((job) => (
            <div
              key={job.role}
              className={`relative rounded-2xl border bg-card p-5 flex flex-col gap-4 transition-all hover:shadow-md hover:-translate-y-0.5 cursor-pointer
                ${
                  job.featured
                    ? "border-primary/40 dark:border-accent/40 shadow-sm ring-1 ring-primary/10 dark:ring-accent/10"
                    : "border-border"
                }`}
            >
              {/* Company row */}
              <div className="flex items-start justify-between">
                ...
                <button className="w-8 h-8 rounded-full flex items-center justify-center border border-border hover:bg-surface-hover transition-colors">
