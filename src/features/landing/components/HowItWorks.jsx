...
export default function HowItWorks() {
  ...
  const applicantSteps = [
    {
      id: 1,
      title: t("howItWorks.applicantSteps.step1.title"),
      desc: t("howItWorks.applicantSteps.step1.description"),
      icon: ClipboardList,
    },
    {
      id: 2,
      title: t("howItWorks.applicantSteps.step2.title"),
      desc: t("howItWorks.applicantSteps.step2.description"),
      icon: FileText,
    },
    {
      id: 3,
      title: t("howItWorks.applicantSteps.step3.title"),
      desc: t("howItWorks.applicantSteps.step3.description"),
      icon: MessageSquare,
    },
    {
      id: 4,
      title: t("howItWorks.applicantSteps.step4.title"),
      desc: t("howItWorks.applicantSteps.step4.description"),
      icon: CheckCircle,
    },
  ];
  ...
  const recruiterSteps = [
    {
      id: 1,
      title: t("howItWorks.recruiterSteps.step1.title"),
      desc: t("howItWorks.recruiterSteps.step1.description"),
      icon: FileText,
    },
    {
      id: 2,
      title: t("howItWorks.recruiterSteps.step2.title"),
      desc: t("howItWorks.recruiterSteps.step2.description"),
      icon: Eye,
    },
    {
      id: 3,
      title: t("howItWorks.recruiterSteps.step3.title"),
      desc: t("howItWorks.recruiterSteps.step3.description"),
      icon: Users,
    },
    {
      id: 4,
      title: t("howItWorks.recruiterSteps.step4.title"),
      desc: t("howItWorks.recruiterSteps.step4.description"),
      icon: Award,
    },
  ];
  ...
  return (
    <section
      id="how-it-works"
      className="bg-background px-6 py-24 lg:px-8 relative overflow-hidden"
    >
      ...
      <div className="max-w-6xl mx-auto space-y-12 relative z-10">
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground text-sm">
            {role === "applicant"
              ? t("howItWorks.applicantSubtitle")
              : t("howItWorks.recruiterSubtitle")}
          </p>
