      ...
      <SectionCard icon={BookOpen} title="About">
        <div>
          ...
          <div className="flex items-center gap-2 mt-3">
            ...
            <button onClick={onSaveBio} disabled={savingBio} className="flex items-center gap-1 px-2.5 py-1 text-xs font-medium text-primary-foreground bg-primary rounded-md hover:bg-primary/90 disabled:opacity-50 transition-colors">
