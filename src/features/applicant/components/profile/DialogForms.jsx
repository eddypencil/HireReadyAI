      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <InputField
            ...
            type="month"
            value={data.from || ""}
            onChange={(v) => handleDialogChange("from", v)}
          />
          <InputField
            label="End Date"
            type="month"
            value={data.to || ""}
            onChange={(v) => handleDialogChange("to", v)}
          />
        </div>
        <InputField
          label="Description"
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <InputField
            ...
            type="month"
            value={data.date || ""}
            onChange={(v) => handleDialogChange("date", v)}
          />
          <InputField
            label="Field"
            value={data.field || ""}
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <InputField
            ...
            type="month"
            value={data.start || ""}
            onChange={(v) => handleDialogChange("start", v)}
          />
          <InputField
            label="End Date"
            type="month"
            value={data.end || ""}
            onChange={(v) => handleDialogChange("end", v)}
          />
        </div>
        <InputField
          label="Description"
