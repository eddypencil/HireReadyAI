      ...
      {applications.length === 0 ? (
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mb-6 max-w-sm mx-auto">
            Feedback and evaluation results will appear here once your applications
            are reviewed by recruiters or completed through the hiring process.
          </p>
            ...
            {!app ? (
              ...
              >
                ...
                <p className="text-muted-foreground font-medium">
                  Select an application to view feedback
                </p>
              </motion.div>
            ) : (
              <>
                ...
                >
                  ...
                  {(cvFeedback || stagesWithQuestions.length > 0 || selectedJob?.id) && (
                    <div className={`space-y-5 ${allStages.length === 0 ? "lg:col-span-3" : ""}`}>
                      <SkillsToDevelop
                        cvFeedback={cvFeedback}
                        stages={stagesWithQuestions}
                      />
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-xs font-normal text-muted-foreground ml-1">
                        (CV review, dimension scores, assessments)
                      </span>
                    </button>
