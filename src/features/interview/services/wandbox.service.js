...
export const WANDBOX_LANGUAGES = {
  // Language key → { compiler, language, monacoLang }
  python: {
  ...
  kotlin: {
    compiler: "scala-3.5.1",  // Wandbox has no Kotlin; closest JVM lang
    language: "Scala",
    monacoLang: "scala",
  },
  r: {
...
export async function executeCode(code, language) {
  ...
  try {
    ...
    return {
      ...
      executionTime: executionTimeMs, // Approximated by network round-trip
      memoryUsage: null, // Memory cannot be faked reliably
