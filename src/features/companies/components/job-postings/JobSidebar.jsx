      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-2.5 py-3 space-y-1 bg-muted/20">
          {filteredJobs.length === 0 ? (
            <div className="text-xs text-muted-foreground text-center py-6 font-medium">No jobs found.</div>
          ) : (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between">
                      ...
                      {status === "Published" ? (
                        <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 shrink-0 ml-2 shadow-[0_0_4px_rgba(16,185,129,0.4)]" title="Published"></span>
                      ) : (
                        <span className="w-1.5 h-1.5 rounded-full bg-muted-foreground/30 shrink-0 ml-2" title="Closed"></span>
                      )}
                    </div>
