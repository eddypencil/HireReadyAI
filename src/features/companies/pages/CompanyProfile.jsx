      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
          ...
          <div className="flex gap-6 items-start">
            <div className="w-16 h-16 bg-dark-amethyst-50 border border-dark-amethyst-100 rounded-xl flex items-center justify-center text-dark-amethyst-600 shrink-0 font-bold text-xl">
            ...
            <div className="grid grid-cols-2 gap-4 grow">
              <div>
                ...
                <input
                  ...
                  disabled
                  value={company?.name || ""}
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm bg-gray-50/30 focus:outline-none focus:border-dark-amethyst-400 focus:bg-white"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-500 mb-1.5">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
          ...
          <form
            ...
            className="flex gap-3 mb-6 bg-gray-50 p-3 rounded-lg border border-gray-100"
          >
            <input
              required
              type="text"
              ...
              className="flex-1 px-3 py-1.5 bg-white border border-gray-200 rounded-md text-xs focus:outline-none focus:border-dark-amethyst-400"
            />
            <input
              required
              type="email"
            ...
            <button
              type="submit"
              className="flex items-center gap-1 bg-dark-amethyst-950 text-white px-4 py-1.5 rounded-md text-xs font-medium hover:bg-dark-amethyst-900 transition-colors cursor-pointer"
            >
            ...
            {members.map((member, i) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-dark-amethyst-950">
                ...
                <span
                  className={`px-2.5 py-1 rounded-md text-[11px] font-medium border border-black/5 bg-gray-100 text-gray-600`}
                >
                  {member.profiles?.role || "Team Member"}
                </span>
              </div>
