...
const DUMMY_JD = {
  about:
    "You'll be joining a fast-growing team where your work will have real impact from day one. We believe in autonomy, clear ownership, and building things that last. If you're passionate about solving hard problems and collaborating with talented people, this role is for you.",
  responsibilities: [
...
export default function JDGeneratorPage() {
  ...
  function handleGenerate(e) {
    ...
    if (keyNotes.trim()) {
      ...
      setGeneratedResponsibilities(
        parsed.length > 0
          ? [...parsed, ...DUMMY_JD.responsibilities]
          : DUMMY_JD.responsibilities,
      );
    } else {
  ...
  const preview = {
    ...
    location:
      [location, workLocation].filter(Boolean).join(" · ") || "Location",
    seniority: seniority || "",
  };
    ...
    <div className="min-h-screen bg-dark-amethyst-50 p-6">
      <div className="max-w-7xl mx-auto mb-6 flex items-start justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="px-4 py-2.5 rounded-xl text-sm font-semibold text-white bg-dark-amethyst-400 flex items-center gap-2 cursor-pointer">
          ...
          {!generated ? (
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-dark-amethyst-500 text-sm mt-1">
                  {[preview.location, preview.seniority]
                    .filter(Boolean)
                    .join(" · ")}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-dark-amethyst-700 text-sm leading-relaxed">
                  {DUMMY_JD.about}
                </p>
              </div>
